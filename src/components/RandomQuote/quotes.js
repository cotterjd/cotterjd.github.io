export default [
  ...
  `"The game of basketball of great. That's what gives one guy corn and the other guy a fireplace" - Dave Smith`,
  ...
  `"I have a theory in life. It's about people and personal behavior. It's either a variable of competence or a variable of commitment." Phil Waldron`,
  `"Your future is whatever you make it - Doc (Emmit Brown)`,
  ...
  `...Does this mean that individuals will always choose correctly or morally when confronted with choices in life? Of course not. But it is only through a continuous process of having to choose, and of having to bear the consequences of choice, that the individual can ever hope to gain a high sense of conscience, responsibility, and morality...while I have met only a few of the people living on earth during my lifetime, I have yet to encounter a single person who has achieved such mastery over his life and conduct that he is now competent to begin passing judgment over, and reforming, others...Then, let us use God’s, not Caesar’s, methods in helping to bring our fellow humans to a life of happiness, peace, and fulfillment! My major difference with conservatives is that they wish to conserve, rather than end, an economic system which is not only evil and immoral but also a denigration of the great God-given gifts of life, liberty, property, and conscience which once constituted the great heritage of this nation." - Jacob G. Hornberger`,
  ...
  `"That's why I could never to a leftist. I like to laugh too much - Mance Rader`,
  ...
  `"We have no compassion and we ask no compass from you. When our time comes we will make no excuse for the terror" - Marx`,
